...
func TestOpenReception(t *testing.T) {
	...
	t.Run("Successful opening of reception", func(t *testing.T) {
		postReceptionsMock.AddReceptionMock.Expect(minimock.AnyContext, uuid.MustParse(reqBody.PVZID)).Return(&model.ReceptionsResp{}, nil)
	...
	t.Run("Status bad request when pvz not exist", func(t *testing.T) {
		postReceptionsMock.AddReceptionMock.Expect(minimock.AnyContext, uuid.MustParse(reqBody.PVZID)).Return(nil, storage.ErrPVZNotExist)
	...
	t.Run("Status bad request when previous reception not closed", func(t *testing.T) {
		postReceptionsMock.AddReceptionMock.Expect(minimock.AnyContext, uuid.MustParse(reqBody.PVZID)).Return(nil, storage.ErrPreviousReceptionNotClosed)
	...
	t.Run("Internal Server Error", func(t *testing.T) {
		postReceptionsMock.AddReceptionMock.Expect(minimock.AnyContext, uuid.MustParse(reqBody.PVZID)).Return(nil, errors.New("no baby not today"))
