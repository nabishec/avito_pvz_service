...
func TestCloseLastReception(t *testing.T) {
	...
	t.Run("Successful close last reception", func(t *testing.T) {
		...
		postCloseLastReceptionsMock.CloseLastReceptionsMock.Expect(minimock.AnyContext, uuid.MustParse(pvzID)).Return(nil)
	...
	t.Run("Status Bad Request open reception not exist", func(t *testing.T) {
		...
		postCloseLastReceptionsMock.CloseLastReceptionsMock.Expect(minimock.AnyContext, uuid.MustParse(pvzID)).Return(storage.ErrOpenReceptionNotExist)
	...
	t.Run("Status Internal Server Error", func(t *testing.T) {
		...
		postCloseLastReceptionsMock.CloseLastReceptionsMock.Expect(minimock.AnyContext, uuid.MustParse(pvzID)).Return(errors.New("not today baby"))
