...
func TestDeleteLastProduct(t *testing.T) {
	...
	t.Run("Successful delete last product", func(t *testing.T) {
		...
		postDeleteLastProducts.DeleteLastProductsMock.Expect(uuid.MustParse(pvzID)).Return(nil)
	...
	t.Run("Status Bad Request open reception not exist", func(t *testing.T) {
		...
		postDeleteLastProducts.DeleteLastProductsMock.Expect(uuid.MustParse(pvzID)).Return(storage.ErrOpenReceptionNotExist)
	...
	t.Run("Status Bad Request not product in request", func(t *testing.T) {
		...
		postDeleteLastProducts.DeleteLastProductsMock.Expect(uuid.MustParse(pvzID)).Return(storage.ErrProductsInReceptionNotExist)
	...
	t.Run("Status Internal Server Error", func(t *testing.T) {
		...
		postDeleteLastProducts.DeleteLastProductsMock.Expect(uuid.MustParse(pvzID)).Return(errors.New("good var love bad func"))
